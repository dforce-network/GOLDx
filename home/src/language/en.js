export default {
  ...
  PricePeg: "PricePeg",
  PricePegContent:
    "Given the underlying assets are gold tokens redeemable for physical gold, GOLDx’s market price is tracking the real-time price from LME, serving as the best proxy for gold exposure",
  ...
  DeFiCompatibilityContent:
    "Zero fees associated with GOLDx’s on-chain transactions, 100% compatible with all DeFi protocols and easy for DeFi integrations (noted that there will be fee levied by PAXG issuer, i.e Paxos for conversions to PAXG, mintage and gas fees for using the Ethereum network)",
  ...
  EasyAccessibilityContent:
    "dForce Swap supports the swap of GOLDx against all mainstreamed stablecoins,including USDx/USDT/USDC/DAI/ PAX/BUSD/HUSD/TUSD. There will also be other exchanges onboarding GOLDx",
  InterestBearing: "Interest-bearing",
  InterestBearingContent:
    "All DeFi protocols across the dForce ecosystem will support GOLDx and will create an interest rate market for it, truly GOLDx with yield",
