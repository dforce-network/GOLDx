...
import icon_mint from '../images/icon_mint.svg';
import icon_pendding from '../images/icon_pendding.svg';
import icon_redeem from '../images/icon_redeem.svg';
                ...
                <div className="history-item" key={i}>
                  ...
                  <div className="history-item-right">
                    ...
                    <div className="history-item-right-bottom">
                      {item.action === 'mint' && <FormattedMessage id='mint' />}
                      {item.action === 'redeem' && <FormattedMessage id='redeem' />}
                      {' ' + format_num_to_K(format_bn(item.send_amount, 18, 6)) + ' '}
                      {item.send_token}
                      {', '}
                      <FormattedMessage id='receive' />
                      {' ' + format_num_to_K(format_bn(item.recive_amount, 18, 6)) + ' '}
                      {item.recive_token}
                    </div>
                  </div>
                </div>
